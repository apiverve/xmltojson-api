// Package xmltojson provides a Go client for the XML to JSON API.
//
// For more information, visit: https://apiverve.com/marketplace/xmltojson?utm_source=go&utm_medium=readme
package xmltojson
...
// Request contains the parameters for the XML to JSON API.
//
// Parameters:
//   - xml (required): string - The XML content to convert to JSON
type Request struct {
	Xml string `json:"xml"` // Required
}
...
// ResponseData contains the data returned by the XML to JSON API.
type ResponseData struct {
	Note NoteData `json:"note"`
}

// NoteData represents the note object.
type NoteData struct {
	Children []ChildrenItem `json:"children"`
}

// ChildrenItem represents an item in the Children array.
