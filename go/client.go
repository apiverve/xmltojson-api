...
const (
	baseURL        = "https://api.apiverve.com/v1/xmltojson"
	defaultTimeout = 30 * time.Second
)

// Client is the XML to JSON API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new XML to JSON API client.
...
// Execute makes a request to the XML to JSON API with typed parameters.
//
