...
namespace APIVerve.API.XMLtoJSON
{
    ...
    /// <summary>
    /// Client for the XMLtoJSON API
    /// </summary>
    public class XMLtoJSONAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/xmltojson";
        ...
        {
            { "xml", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public XMLtoJSONAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public XMLtoJSONAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public XMLtoJSONAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, XMLtoJSONQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(XMLtoJSONQueryOptions options)
        {
        ...
        public ResponseObj Execute(XMLtoJSONQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(XMLtoJSONQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(XMLtoJSONQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(XMLtoJSONQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(XMLtoJSONQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(XMLtoJSONQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(XMLtoJSONQueryOptions options)
        {
