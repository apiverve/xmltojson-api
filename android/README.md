...
```java
import com.apiverve.xmltojson.XMLtoJSONAPIClient;
import com.apiverve.xmltojson.APIResponse;
import com.apiverve.xmltojson.APIException;

// Initialize the client
XMLtoJSONAPIClient client = new XMLtoJSONAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/xmltojson](https://docs.apiverve.com/ref/xmltojson)
...
- **Documentation:** [https://docs.apiverve.com/ref/xmltojson](https://docs.apiverve.com/ref/xmltojson)
- **Issues:** [GitHub Issues](https://github.com/apiverve/xmltojson-api/issues)
